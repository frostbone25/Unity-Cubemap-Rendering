...
namespace ImprovedCubemapRendering
{
    public class RealtimeTetrahedralRenderingV1 : MonoBehaviour
    {
        ...
        private void SetupRealtimeRendering()
        {
            ...
            tetrahedralRenderingComputeShader.SetVector(RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedronFaceResolution, new Vector4(tetrahedronFaceRender.width, tetrahedronFaceRender.height, 0.0f, 0.0f));
            tetrahedralRenderingComputeShader.SetVector(RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedronMapResolution, new Vector4(tetrahedronMap.width, tetrahedronMap.height, 0.0f, 0.0f));

            tetrahedralRenderingComputeShader.SetTexture(computeShaderTetrahedralFaceCombine, RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedronFaceRender, tetrahedronFaceRender);
            tetrahedralRenderingComputeShader.SetTexture(computeShaderTetrahedralFaceCombine, RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedronFaceMapOutput, tetrahedronMap);

            tetrahedralRenderingComputeShader.SetTexture(computeShaderTetrahedralMapToCubemap, RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedralColorMap, tetrahedronMap);
            tetrahedralRenderingComputeShader.SetTexture(computeShaderTetrahedralMapToCubemap, RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedralCubemapLUT, cubemapToTetrahedralLUT);
            tetrahedralRenderingComputeShader.SetTexture(computeShaderTetrahedralMapToCubemap, RealtimeTetrahedralRenderingV1ShaderIDsV1.CubemapOutput, intermediateCubemap);
        ...
        public void RenderRealtimeTetrahedronMap()
        {
            ...
            */
            ...
            probeCamera.Render();
            tetrahedralRenderingComputeShader.SetInt(RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedronFaceIndex, 0);
            ...
            probeCamera.Render();
            tetrahedralRenderingComputeShader.SetInt(RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedronFaceIndex, 1);
            tetrahedralRenderingComputeShader.Dispatch(computeShaderTetrahedralFaceCombine, computeShaderTetrahedralFaceCombineX, computeShaderTetrahedralFaceCombineY, computeShaderTetrahedralFaceCombineZ);
            ...
            probeCamera.Render();
            tetrahedralRenderingComputeShader.SetInt(RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedronFaceIndex, 2);
            tetrahedralRenderingComputeShader.Dispatch(computeShaderTetrahedralFaceCombine, computeShaderTetrahedralFaceCombineX, computeShaderTetrahedralFaceCombineY, computeShaderTetrahedralFaceCombineZ);
            ...
            probeCamera.Render();
            tetrahedralRenderingComputeShader.SetInt(RealtimeTetrahedralRenderingV1ShaderIDsV1.TetrahedronFaceIndex, 3);
            tetrahedralRenderingComputeShader.Dispatch(computeShaderTetrahedralFaceCombine, computeShaderTetrahedralFaceCombineX, computeShaderTetrahedralFaceCombineY, computeShaderTetrahedralFaceCombineZ);
